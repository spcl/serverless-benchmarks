...
class PerfCost(Experiment):
    ...
    def run(self):
        ...
        for memory in memory_sizes:
            ...
            uri = "" if not self._benchmark.container_deployment else self._benchmark.container_uri
            self._deployment_client.update_function(self._function, self._benchmark, self._benchmark.container_deployment, uri)
