...
from sebs.experiments import Experiment, PerfCost, NetworkPingPong, StartupTime, EvictionModel
...
class SeBS:
    ...
    def get_experiment(
        ...
        implementations = {"perf-cost": PerfCost, "network-ping-pong": NetworkPingPong, "eviction-model": EvictionModel, "startup-time": StartupTime}
