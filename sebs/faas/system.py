...
class System(ABC, LoggingBase):
    ...
    def package_code(
        ...
        Args:
            code_package: The benchmark code package
            directory: Directory containing the code
            is_workflow: Whether this is a workflow deployment
            is_cached: Whether the package is cached
...
>>>>>>> origin/master
    ...
    def cached_benchmark(self, function: CloudBenchmark):
        """
        Perform any necessary operations for a cached function or workflow.

        This method is called when a function/workflow is found in the cache. It may perform
        ...
        Args:
            function: The cached function/workflow instance
        """
        pass
    ...
    def get_function(self, code_package: Benchmark, func_name: Optional[str] = None) -> Function:
        ...
        # Note: Second build call is intentional for container deployments
    ...
    def create_workflow_trigger(
        ...
        Args:
            workflow: The workflow to create a trigger for
            trigger_type: Type of trigger to create
