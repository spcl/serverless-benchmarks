...
AWS Python 3.10 and 3.11 use version-specific dependency files. NumPy, ContourPy, and Pillow are pinned to versions with wheels compatible with the Lambda build images so that package construction does not require a compiler.
