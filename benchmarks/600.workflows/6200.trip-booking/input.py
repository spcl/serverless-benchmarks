def allocate_nosql() -> dict:
    ...
    return {
        "flights": {"primary_key": "trip_id", "secondary_key": "flight_id"},
        "car_rentals": {"primary_key": "trip_id", "secondary_key": "rental_id"},
        "hotel_booking": {"primary_key": "trip_id", "secondary_key": "booking_id"},
    }
